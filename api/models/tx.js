...
const tokenValues = {
  ...
  //openrouter models
  'nousresearch/nous-capybara-7b:free': { prompt: 0, completion: 0 },
  ...
  'openrouter/cinematika-7b:free': { prompt: 0, completion: 0 },
  'google/gemma-7b-it:free': { prompt: 0, completion: 0 },
  'jebcarter/psyfighter-13b': { prompt: 1, completion: 1 },
  'koboldai/psyfighter-13b-2': { prompt: 1, completion: 1 },
  ...
  'intel/neural-chat-7b': { prompt: 5, completion: 5 },
  ...
  'haotian-liu/llava-13b': { prompt: 5, completion: 5 },
  'nousresearch/nous-hermes-2-vision-7b': { prompt: 5, completion: 5 },
  'meta-llama/llama-2-13b-chat': { prompt: 0.1474, completion: 0.1474 },
  ...
  'sophosympatheia/midnight-rose-70b': { prompt: 9, completion: 9 },
  ...
  'open-orca/mistral-7b-openorca': { prompt: 0.1425, completion: 0.1425 },
  'huggingfaceh4/zephyr-7b-beta': { prompt: 0.1425, completion: 0.1425 },
  'openai/gpt-3.5-turbo': { prompt: 1, completion: 2 },
  'openai/gpt-3.5-turbo-0125': { prompt: 0.5, completion: 1.5 },
  'openai/gpt-3.5-turbo-1106': { prompt: 1, completion: 2 },
  'openai/gpt-3.5-turbo-0613': { prompt: 1, completion: 2 },
  'openai/gpt-3.5-turbo-0301': { prompt: 1, completion: 2 },
  'openai/gpt-3.5-turbo-16k': { prompt: 3, completion: 4 },
  'openai/gpt-4-turbo-preview': { prompt: 10, completion: 30 },
  'openai/gpt-4-1106-preview': { prompt: 10, completion: 30 },
  'openai/gpt-4': { prompt: 30, completion: 60 },
  'openai/gpt-4-0314': { prompt: 30, completion: 60 },
  'openai/gpt-4-32k': { prompt: 60, completion: 120 },
  'openai/gpt-4-32k-0314': { prompt: 60, completion: 120 },
  'openai/gpt-4-vision-preview': { prompt: 10, completion: 30 },
  'openai/gpt-3.5-turbo-instruct': { prompt: 1.5, completion: 2 },
  ...
  'anthropic/claude-3-opus:beta': { prompt: 15, completion: 75 },
  'anthropic/claude-3-sonnet:beta': { prompt: 3, completion: 15 },
  ...
  'neversleep/noromaid-mixtral-8x7b-instruct': { prompt: 8, completion: 8 },
  'rwkv/rwkv-5-world-3b': { prompt: 0, completion: 0 },
  'recursal/rwkv-5-3b-ai-town': { prompt: 0, completion: 0 },
  'recursal/eagle-7b': { prompt: 0, completion: 0 },
  'google/gemma-7b-it': { prompt: 0.13, completion: 0.13 },
  'databricks/dbrx-instruct': { prompt: 0.9, completion: 0.9 },
  'anthropic/claude-2': { prompt: 8, completion: 24 },
  'anthropic/claude-2.1': { prompt: 8, completion: 24 },
  'anthropic/claude-2.0': { prompt: 8, completion: 24 },
  'anthropic/claude-instant-1': { prompt: 0.8, completion: 2.4 },
  'anthropic/claude-instant-1.2': { prompt: 0.8, completion: 2.4 },
  'anthropic/claude-1': { prompt: 8, completion: 24 },
  'anthropic/claude-1.2': { prompt: 8, completion: 24 },
  'anthropic/claude-instant-1.0': { prompt: 0.8, completion: 2.4 },
  'anthropic/claude-instant-1.1': { prompt: 0.8, completion: 2.4 },
  'anthropic/claude-2:beta': { prompt: 8, completion: 24 },
  'anthropic/claude-2.1:beta': { prompt: 8, completion: 24 },
  'anthropic/claude-2.0:beta': { prompt: 8, completion: 24 },
  ...
  'mistralai/mistral-small': { prompt: 2, completion: 6 },
  'mistralai/mistral-medium': { prompt: 2.7, completion: 8.1 },
  'mistralai/mistral-large': { prompt: 8, completion: 24 },
  'cohere/command': { prompt: 1, completion: 2 },
  'cohere/command-r': { prompt: 0.5, completion: 1.5 },
  'cohere/command-r-plus': { prompt: 3, completion: 15 },
};
